...
<div id="functionsChart"><br/>
	<h1>All Cognitive Functions</h1><br/>
	<table id="cog_table2">
	<tr>
	<td id="aSe"><h2 class="Se"><?=$functions[0][0];?></h2></td>
	<td id="aNe"><h2 class="Ne"><?=$functions[1][0];?></h2></td>
	<td id="aTe"><h2 class="Te"><?=$functions[2][0];?></h2></td>
	<td id="aFe"><h2 class="Fe"><?=$functions[3][0];?></h2></td>
	</tr>
	<tr>
	<td id="aSi"><h2 class="Si"><?=$functions[4][0];?></h2></td>
	<td id="aNi"><h2 class="Ni"><?=$functions[5][0];?></h2></td>
	<td id="aTi"><h2 class="Ti"><?=$functions[6][0];?></h2></td>
	<td id="aFi"><h2 class="Fi"><?=$functions[7][0];?></h2></td>				
	</tr>
</div>
